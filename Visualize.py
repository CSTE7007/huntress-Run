...
#inferred = scp.io.read(scp.ul.get_file("scphylo.datasets/test/fp_0-fn_0-na_0.ground.CFMatrix"))
inferred = scp.io.read("Demo_reconstructed.CFMatrix")
...
# MIK added this lines
#print(inferred)
print(type(tree))
print(type(scp.pl.clonal_tree(tree)))
